...
<div
  ...
  aria-expanded={_ariaexpanded.length > 0 ? _ariaexpanded : undefined}
...
<style>
  ...
  /* override height when a custom svg icon is used to ensure svg retains dims */
