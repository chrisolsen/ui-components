...
<script lang="ts">
  ...
  let navEl: HTMLSlotElement;
  let metaEl: HTMLSlotElement;
  ...
  onMount(async () => {
    await tick();
    navLinks = navEl.assignedElements();
    metaLinks = metaEl.assignedElements();
...
<footer class="app-footer">
  ...
  >
    <div class="meta-links">
      <slot bind:this={metaEl} name="meta" />
    </div>
    ...
    >
      ...
      <a href="#" class="goa-copyright">© 2022 Government of Alberta</a>
    </div>
  </footer>
</footer>
