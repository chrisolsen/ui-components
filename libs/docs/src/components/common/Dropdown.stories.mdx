...
export const Template = (args) => {
  ...
  return (
    <GoADropdown {...args} name={args.name} values={value} onChange={onChange}>
...
<Tabs>
    ...
    <CodeSnippet lang="js" code={`
      export class MyComponent {
        ...
        selectColor(event: any) {
          this.selectedColors = event.detail.value;
        }
      }
    `}/>
  </Tab>
  <Tab label="React">
    <CodeSnippet lang="tsx" code={`
      const [values, setValues] = useState(['green']);
      function onChange(name, values) {
        setValues(values);
      }
      return (
        <GoADropdown name="colors" values={values} onChange={onChange}>
...
#### Multi selection
<Story name="Multiselect" args={{ name: "multiselect", multiselect: true }}>
  { Template.bind() }
</Story>
...
<Tabs>
  <Tab label="Web Component">
    <CodeSnippet lang="html" code={`
      <goa-dropdown id="dropdown" name="colors" multiselect="true">
        <goa-dropdown-item value="red" name="colors" label="Red" />
        <goa-dropdown-item value="green" name="colors" label="Green" />
        <goa-dropdown-item value="blue" name="colors" label="Blue" />
      </goa-dropdown>
  ...
  <Tab label="React">
    <CodeSnippet lang="tsx" code={`
      ...
      return (
        <GoADropdown name="colors" multiselect={true} values={values} onChange={onChange}>
          <GoADropdownOption name="colors" value="red" label="Red" />
          <GoADropdownOption name="colors" value="green" label="Green" />
          <GoADropdownOption name="colors" value="blue" label="Blue" />
        </GoADropdown>
...
<Tabs>
  ...
  <Tab label="Angular">
    <CodeSnippet lang="html" code={`
      <goa-dropdown name="colors" placeholder="Select a user" error="true">
  ...
  <Tab label="React">
    <CodeSnippet lang="tsx" code={`
      <GoADropdown name="colors" error={true} values={values} onChange={() => {}}>
        <GoADropdownOption name="colors" value="red" label="Red" />
        <GoADropdownOption name="colors" value="green" label="Green" />
        <GoADropdownOption name="colors" value="blue" label="Blue" />
      </GoADropdown>
...
#### Filter
<Story name="Filter" args={{ name: "filterable", filterable: true }}>
  { Template.bind() }
</Story>
...
<Tabs>
  <Tab label="Web Component">
    <CodeSnippet lang="html" code={`
      <goa-dropdown id="dropdown" name="colors" filterable="true">
        <goa-dropdown-item value="red" name="colors" label="Red" />
        <goa-dropdown-item value="green" name="colors" label="Green" />
        <goa-dropdown-item value="blue" name="colors" label="Blue" />
      </goa-dropdown>
  ...
  <Tab label="Angular">
    <CodeSnippet lang="html" code={`
      <goa-dropdown name="colors" placeholder="Select a user" filterable="true">
        <goa-dropdown-item value="red" name="colors" label="Red"></goa-dropdown-item>
        <goa-dropdown-item value="green" name="colors" label="Green"></goa-dropdown-item>
        <goa-dropdown-item value="blue" name="colors" label="Blue"></goa-dropdown-item>
      </goa-dropdown>
  ...
  <Tab label="React">
    <CodeSnippet lang="tsx" code={`
      <GoADropdown name="colors" filterable={true} values={values} onChange={() => {}}>
        <GoADropdownOption name="colors" value="red" label="Red" />
        <GoADropdownOption name="colors" value="green" label="Green" />
        <GoADropdownOption name="colors" value="blue" label="Blue" />
      </GoADropdown>
