...
<Props showTabs={true}>
  ...
  <Prop
    ...
    type="boolean"
    defaultValue="false"
    description="Show/hide the character counter"
  />
  <Prop name="maxCharCount" type="number" description="Set the max character count" />
...
<Tabs>
  ...
  <Tab label="Angular">
    <CodeSnippet
      lang="html"
      code={`
      <goa-textarea name="comment" (_change)="onChange($event)" value="Initial value"></goa-textarea>
    `}
    />
    <CodeSnippet
      lang="ts"
...
<Tabs>
  ...
  <Tab label="Angular">
    <CodeSnippet
      lang="html"
      code={`
      <goa-textarea name="comment" showCounter="true" (_change)="onChange($event)" [value]="val"></goa-textarea>
    `}
    />
    <CodeSnippet
      lang="ts"
...
<Tabs>
  ...
  <Tab label="Angular">
    <CodeSnippet
      lang="html"
      code={`
      <goa-textarea name="comment" showCounter="true" maxCharCount="20" (_change)="onChange($event)" [value]="val"></goa-textarea>
    `}
    />
    <CodeSnippet
      lang="ts"
