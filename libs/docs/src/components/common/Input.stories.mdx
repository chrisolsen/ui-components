...
<Tabs>
  <Tab label="Web Component">
    <CodeSnippet
      code={`<goa-input name="firstname" width="100%" />`}
      lang="html"
    />
  </Tab>
  <Tab label="Angular">
    <CodeSnippet
      code={`<goa-input name="firstname" width="100%"></goa-input>`}
      lang="html"
    />
  </Tab>
  <Tab label="React">
    <CodeSnippet
      code={`return <GoAInput name="firstname" width="100%" onChange={() => {}} />`}
      lang="tsx"
    />
  </Tab>
</Tabs>
