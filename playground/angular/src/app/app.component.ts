...
import { dateValidator, FieldsetState, requiredValidator, validate } from "./validation";
import { PublicFormController, relay } from "@abgov/angular-components";
...
export class AppComponent extends PublicFormController<Page> {
  constructor() {
    super("details");
  }
